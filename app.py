...
#Exploratory Data Analysis (EDA)
    ...
    eda_type = st.multiselect("Visualization Options", ["Histograms", "Boxplots", "Scatterplots", "Count Plots"])
...
#Extras
    ...
    with tab1:
        st.write("Place whatever you want in the first tab here")
    ...
    st.write("this is ouside the container")
